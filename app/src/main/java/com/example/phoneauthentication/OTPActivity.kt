...
class OTPActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*********************************************************most of the time same code**************************************************/
        verifyBtn.setOnClickListener {
            /*********************************************COLLECTING OTP FROM EDIT TEXT WITH THE HELP OF LAST TWO FUNCTIONS********************/
            val typedOTP =
    ...
    private fun resendVerificationCode() {
        val options = PhoneAuthOptions.newBuilder(auth)
            ...
            .setForceResendingToken(resendToken)         // for resending the OTP
            .build()
    ...
    /************************************************Methods so that the cursor move to the next box automativally******************************/
